...
var Marquee = function (_a) {
    ...
    var _b = useState("running"), animate = _b[0], setAnimate = _b[1];
    var _c = useState(0), id = _c[0], setId = _c[1];
    useEffect(function () {
        setId(marqueeCounter);
        marqueeCounter++;
    }, []);
    var offsetValues = [-1, 0, 1];
    return (jsx("div", __assign({ className: className, onMouseEnter: function () { return pauseOnHover && setAnimate("paused"); }, onMouseLeave: function () { return pauseOnHover && setAnimate("running"); }, style: {
            display: "flex",
            overflow: "hidden",
            alignItems: "center",
            position: "relative",
            ...
            width: width !== null && width !== void 0 ? width : "100%",
        } }, { children: offsetValues.map(function (offset) { return (jsxs("span", __assign({ style: {
                ...
                minWidth: "100%",
            } }, { children: [jsx(Animation, { reverse: reverse, offset: offset, axis: axis, id: id }, void 0),
